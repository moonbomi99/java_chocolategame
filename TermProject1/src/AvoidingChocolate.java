...
public class AvoidingChocolate {
	...
	private void prepareFalling() {
		...
		chocolateList.add(new MovingShape(getClass().getResource(CHOCOLATE_PIC), C_MARGIN, (int) (Math.random() * 10)+7, gamePanelWidth, gamePanelHeight));
	}
	...
	private class ClockListener implements ActionListener {
		...
		public void actionPerformed (ActionEvent event) {		
			...
			if (time % CHOCOLATE_INTERVAL == 0)
				chocolateList.add(getChocolate(CHOCOLATE_PIC, C_MARGIN, (int) (Math.random() * 10)+7));
